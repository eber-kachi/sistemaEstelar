...
insert into categoria
      (nombre)
values('Tres Estrellas');
insert into categoria
      (nombre)
values('Cuatro Estrellas');
insert into categoria
      (nombre)
values('Cinco Estrellas');
...
insert into agencia
      (nombre)
values('Delicias Tours');
insert into agencia
      (nombre)
values('Tropical Tours');
insert into agencia
      (nombre)
values('Genesis Tours');
...
values
      (1, 'Estelar Cochabamba 1', 44356789, 'Los pinos Zona Norte Nro 234');

insert into hotel
      (idDepartamento,nombre,telefono,direccion)
values
      (1, 'Estelar Cochabamba 2', 45678908, 'Colombia esquina San Martin Nro 678');

insert into hotel
      (idDepartamento,nombre,telefono,direccion)
values
      (1, 'Estelar Cochabamba 3', 45678903, 'Libertador Nro 456');

insert into hotel
      (idDepartamento,nombre,telefono,direccion)
values
      (1, 'Estelar Cochabamba 4', 78900001, 'Chapare - Villa Tunari');

insert into hotel
      (idDepartamento,nombre,telefono,direccion)
values
      (1, 'Estelar Cochabamba 5', 47878789, 'Chapare - San Isidro');
...
insert into historialHotel
      (idHotel,idCategoria,fechaInicio,fechaFin,observaciones,activo)
...
-- recepcionistas
insert into usuario
      (idRol,idHotel,ciUsuario,primerNombre,segundoNombre,apellidoPaterno,apellidoMaterno,usuario,contrasenia,activo)
...
insert into cliente
      (idHotel, ci, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, telefono, genero, fechaNacimiento, usuario,contrasenia, activo)
values(1, '2001', 'Veronica', 'Lidia', 'Uriona', 'Fernandez', 60540001, 'F', '1985-06-27', '2001', '321', 1),

      (1, '2002', 'Vanesa', '', 'Borda', 'Lopez', 60540002, 'F', '1979-12-01', '', '', 1),

      (1, '2003', 'Santiago', 'Luis', 'Pineiro', 'Lazarte', 60540003, 'M', '1980-08-11', '', '', 1),

      (1, '2004', 'Eliel', '', 'Ramirez', 'Bustamante', 60540004, 'M', '1985-09-24', '', '', 1),

      (1, '2005', 'Diana', 'Sarai', 'Cardozo', 'Villanueva', 60540004, 'F', '1982-02-27', '', '', 1);

-- reserva por agencia de viaje
-- individual, alex navarro, Rolando Guardia(Viajero Club)  
insert into reserva
      (idHabitacion,idUsuario,idAgenteTuristico,fechaInicio,fechaFin,montoTotal,reservaPersonal,reservaOnline,activo)
